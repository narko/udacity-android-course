...
//        }
    ...
    private class ForecastAsyncTask extends AsyncTask<URL, Void, String> {
        ...
        @Override
        protected void onPostExecute(String forecastResultString) {
            if (forecastResultString != null && !forecastResultString.isEmpty()) {
                mWeatherTextView.setText(forecastResultString);
            }
        }
    }
}
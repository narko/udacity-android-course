...
//              (13) Check if notifications are enabled
                if (SunshinePreferences.areNotificationEnable(context)) {
//              (14) Check if a day has passed since the last notification
                    ...
                    if (SunshinePreferences.getEllapsedTimeSinceLastNotification(context) >= TimeUnit.MILLISECONDS.convert(1, TimeUnit.DAYS)) {
